...
A suite to Git commands to easily fixup previous Git commits using `git commit --fixup` and `git rebase`. Works with any commit in the commit tree, including the root commit and merge commits.
...
**fixupCommands.rebaseMerges**

Default is `true`, which enables recreating merge commits to preserve the branch structure. See https://git-scm.com/docs/git-rebase#Documentation/git-rebase.txt-rebaserebaseMerges for options.
